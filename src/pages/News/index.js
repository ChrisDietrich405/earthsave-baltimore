  ...
  return (
    <div className={`page-container ${className}`}>
      <div className="news-in">
        ...
        <br />
        <p>
          Earthsave Baltimore is a volunteer operated nonprofit whose mission is
          embracing a healthier, sustainable, compassionate and peaceful way of
          eating and living. We hope you will stay in touch and join us for an
          event soon.
        </p>
        <p>
          We host vegan potluck meetings at Govans Presbyterian Church, 5828
          York Road in Baltimore, near Towson. Church is next to the historic
          Senator Theater. The potlucks usually meet on the fourth Saturday of
          each month, from 6:00 until 8:15. Attendees are encouraged to be
          up-to- date with Covid shots.
        </p>
        <br />
        <p>
        ...
        <p>
          ...
          OPEN-MIC POTLUCK will happen. The last open-mic was a blast! We had
          live music, book readings and poetry, stand up comedy and more. We
        ...
        <p>
          ...
          and restaurant gatherings by joining one of these groups: &nbsp;
          <a
        ...
        <p>
          ...
          Turkeys – join our friendly turkeys and all their friends in
          celebrating a huge cruelty-free Thanksgiving potluck. It’s outdoors,
          so you will want to dress warmly.&nbsp;
        ...
        <p>
          ...
          like-minded people and learn about local veg/vegan friendly
          restaurants, food sources and events.
          <a
        ...
        <p>
          ...
          is a classic read, an insightful Amazon best-seller by Will Tuttle,
          PhD. The book looks at the far-reaching implications of our food
          choices and offers a set of universal principles for all people of
          conscience that show how we as a species can move our consciousness
          forward.
        </p>
