...
export default function Fascinating() {
    ...
    return (
        ...
        <div>
            ...
            <br/>
            <b>Erectile Dysfunction:</b> <p> Did you know that physicians are now using male erectile dysfunction as a marker for heart disease? The artery that leads down there can become clogged or damaged, just like any other. It can also be restored to vitality, like any other. Let food be your medicine!</p>
            <br/>
            ...
            <br/>
            <p><b>"Your choice of diet</b> can influence your long term health prospects more than any other action you might take." </p>
            <p>Former U.S. Surgeon General <b> ~C. Everett Koop~ </b></p>
            <br/>
            <p><b>"The vast majority</b> ,perhaps 80%-90%, of all cancers, cardiovascular and other forms of degenerative illness can be          prevented, at least to a very old age, simply by adopting a plant-based diet. ...No chemical carcinogen is nearly so            important in causing human cancer as animal protein."</p>
            <p><b> ~T. Colin Campbell, PhD~</b> Director of the China Study, the most comprehensive large study ever undertaken of the          relationship between diet and disease.</p> 
            <br/>
            <p> <b>"There is virtually</b> no evidence that drinking two or three glasses of milk a day reduces the chances of breaking a bone."</p>
            <p> <b> ~Walter C. Willet, MD~</b>  Chairman of the Department of Nutrition, Harvard School of Public Health</p>
            <br/>
            <p> <b>There’s no reason</b> to drink cow’s milk at any time in your life. It was designed for calves, it was not designed for humans, and we should all stop drinking it today."</p> 
            <p> <b> ~Dr. Frank Oski,~</b> former director of pediatrics, Johns Hopkins University~</p>
            <br/>
            <p><b>"Another good reason</b>  to get your nutrition from plant sources is that animals tend to concentrate pesticides and other chemicals in their meat and milk... Plant foods have much less contamination..."</p>
            <p><b>  ~Benjamin Spock, MD~ </b>Pediatrician and author of all time best selling books on health care for children</p> 
            <br/>
            <p> <b> "It is the position</b> of the American Dietetic Association that appropriately planned vegetarian diets, including total            vegetarian or vegan diets, are healthful, nutritionally adequate, and may provide health benefits in the prevention and         treatment of certain diseases. Well-planned vegetarian diets are appropriate for individuals during all stages of the life          cycle, including pregnancy, lactation, infancy, childhood, and adolescence, and for athletes."</p>
            <b> ~American Dietetic Association~</b>
            <p><b>"Whether industrialized societies… </b>can cure themselves of their meat addictions may ultimately be a greater factor in world health than all the doctors, health insurance policies, and drugs put together."</p> 
            <p><b>~T. Colin Campbell, PhD~</b> who was lead scientist in the huge China-Oxford-Cornell Project on Nutrition</p>
            <br/>
            <h4>~QUOTES of Note~ COMPASSIONATE FOOD CHOICES</h4>
            <br/>
            <p><b>"There is no fundamental difference</b>between man and the higher animals in their mental faculties... The lower animals, like man, manifestly feel pleasure and pain, happiness and misery."</p> 
            <p><b>~Charles Darwin~</b> Naturalist, and author of Origin of the Species</p>
            <br/>
            <p><b>"The vast majority</b> of farm animals today are raised in conditions which would shock our consciences. Most people assume that there are laws which protect farm animals from egregious abuse. But what few laws exist are almost never enforced. Consequently, since profit is deemed more important than comfort for the animal, farm animals are routinely and patently abused and neglected."</p>
            <p><b>~John Robbins~</b> Author of Diet for a New America, and Food Revolution</p>
            <br/>
            <p><b>"If slaughterhouses</b> had glass walls, everyone would be vegetarian."</p>
            <p><b>~Paul McCartney~</b></p>
            <br/> 
            <h4><b>~QUOTES of Note~ EARTH-FRIENDLY FOOD CHOICES</b></h4>
            <br/>
            <p><b>"More global warming greenhouse gases</b> are produced by livestock operations than by all forms of transportation combined."</p>  
            <p><b>~United Nations Report: Livestock's Long Shadow~</b> 11/9/06</p>
            <br/>
            <p><b>"We will find</b> that we can no longer subsidize or ignore the costs of mass-producing cattle, poultry, pigs, sheep, and fish to feed our growing population. These costs include hugely inefficient use of fresh water and land, heavy pollution from livestock feces, rising rates of heart disease and other degenerative illnesses, and spreading destruction of forests on which much of the planet’s life depends." </p> 
            <p><b>~Time Magazine~ </b>11/8/99</p>
            <br/>
