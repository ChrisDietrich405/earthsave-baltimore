...
export default function Recommended() {
    return (
        <div className="page-container">
            ...
            <br />
            <p><b>"THE CHINA STUDY"</b>, by T. Colin Campbell, PhD, details some of the most compelling scientific evidence available on the connection between diet and a whole host of chronic diseases that are currently shortening Americans’ lives. Dr. Campbell is the nutritional biochemist from Cornell University who led the Cornell/Oxford/China Health Project, which is the most comprehensive large study ever undertaken of the relationship between diet and disease.</p>
            <br />
            <p><b>"THE NEW BECOMING VEGETARIAN"</b>, by Vesanto Melina, RD; Brenda Davis, RD, is a comprehensive and well-researched manual for achieving optimal nutrition at all stages of life. It includes more than 50 great tasting, easy recipes.</p>
            <br />
            <p><b>"THE WORLD PEACE DIET"</b>, by musician/composer, educator, and Zen Buddhist Master Will Tuttle, PhD, examines, comprehensively, the link between the violence on our dinner plates and a whole, massive cycle of violence in the world today. Tuttle sees animal agriculture as the central link to a broad range of problems - psychological, social, and spiritual, as well as health and environmental. The book offers powerful ways we can all experience healing and peace and contribute to a positive transformation of human consciousness.</p>
            <br />
            <p><b>OUR FOOD OUR FUTURE</b> is an excellent guide to the diverse reasons for shifting to a whole foods, plant based diet. You may view the whole booklet or download a copy for free by going to . You can also purchase a copy for just one dollar at the book table at Earthsave Baltimore potluck events.</p>
            <br />
            <p><b>FLIERS & HANDOUTS</b></p>
            <br />
            <p>You may download and print the items listed as "attachments" at the bottom of this page.</p>
            <br />
            <p>The first item is a flier with information on the next several Earthsave events. Page should be printed on front and reverse and folded to make small brochure. There's helpful information on popular local veg restaurants and nutrition professionals, as well as some good general information about the benefits of a whole food, plant-based diet.</p>
            <br />
            <p>The second item lists the nutritional recommendations of Michael Greger, MD, who is a much respected speaker and author. He's a general practitioner specilizing in clinical nutrition. Each year he reads all of the nutritional journals that are published in English and reveals his findings and recommendations.</p>
            <br />
            <p>The third item is an article by Dr. Dean Ornish about the connection between diet and the most common and deadly chronic diseases. The clinial studies of Dr. Ornish have shown conclusively that dietary change can not only prevent but can reverse even severe coronary artery disease.</p>
            <br />
            <p><b>LINKS to Helpful Websites on...</b></p>
            <br />
